...
//    println(Equals(Mult(z(2), Stroke(ArithmeticVariable("p"))), z(n + 2)).print()) // 2p' = n + 2
...
//    println(Equals(Add(Mult(z(2), ArithmeticVariable("p")), z(1)), z(n + 1)).print()) // 2p + 1 = n + 1
...
//    println(Equals(Add(Mult(z(2), ArithmeticVariable("p")), Zero()), z(n)).print()) // 2p + 0 = n
...
//    println(proof.size)
//    for (line in proof) println(line.print())
}
...
//    val follow = Implication(Negation(Equals(Mult(z(2), ArithmeticVariable("p")), z(1 + 2))), next)
//    println()
}
